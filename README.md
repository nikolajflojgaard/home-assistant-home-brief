...
If the upstream Household Chores integration provides explicit task `slot` values (`morning|afternoon|evening`), Home Brief uses those directly for slot pressure and household contention instead of relying on heuristics.
